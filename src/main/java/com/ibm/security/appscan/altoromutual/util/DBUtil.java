...
public class DBUtil {
	...
	public static void updateHistory(String stockSymbol, Timestamp date, double open, double close, double adjClose,
	...
	public static boolean loadHistoricalData(String stockSymbol, int numDays)  {
		// get 1 year historical data for a stock
		Calendar from = Calendar.getInstance();
		Calendar to = Calendar.getInstance();
		from.add(Calendar.DAY_OF_YEAR , -numDays);
		...
		try {
			...
			for (HistoricalQuote hq: quotes) {
				...
				updateHistory(stockSymbol, date, open, close, adjClose, volume, high, low);
			}
		} catch (IOException e) {
